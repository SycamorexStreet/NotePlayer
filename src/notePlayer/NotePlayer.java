...
public class NotePlayer
{
    ...
    public static int accidental (String x, int y)
    {
    	x =  x.substring(1,x.indexOf("_"));
    	if (x.substring(0).contains("b"))
    	{
    		y--;
    		x = x.substring(x.indexOf("b")+1);
    	}
    	else if (x.substring(0).contains("#"))
    	{
    		y++;
    ...
    public static int MIDI (String x)
    {
    	if (x.equals("0"))
    	{
    		return 0; 
    ...
    public static String note_letter(String x)
    {
    	if (x.contains(","))
    	{
    		x = x.substring(x.indexOf(",")+1,x.indexOf(",")+2 );
    	}
    	else
    	{
    		x = x.substring(0 , 1);
    ...
    public static int note_duration(String x)
    {
    	int startOfD = x.indexOf("_");
    	int endOfD = x.indexOf(" ");
    	x = x.substring(startOfD+1 , endOfD);
    	int inote_duration = Integer.parseInt(x);
    	return inote_duration;
    }
